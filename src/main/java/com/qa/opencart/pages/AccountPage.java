...
public class AccountPage {
	...
	public boolean isLogoutLinkExist() {
		WebElement logoutEle = eleUtil.waitForElementVisible(logoutLink, AppConstant.DEFAULT_MEDIUM_WAIT);
		return eleUtil.isElementDisplayed(logoutEle);
	}

	public SearchReasultPage doSearch(String searchKey) {
		System.out.println("search key -->"+ searchKey);
		WebElement searchEle = eleUtil.waitForElementVisible(search, AppConstant.DEFAULT_MEDIUM_WAIT);
		searchEle.clear();
